...
if ( ! function_exists( 'bazaar_qodef_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function bazaar_qodef_fonts_options_map() {
		
		bazaar_qodef_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'bazaar' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'bazaar' )
			)
		);
		
		//H1
		$group_heading_h1 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = bazaar_qodef_add_admin_row(
			array(
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'bazaar' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h1_3 = bazaar_qodef_add_admin_row(
			array(
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'bazaar' ),
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'bazaar' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h2_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h2_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h3_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h3_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h4_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h4_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h5_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h5_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'bazaar' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'bazaar' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h6_2 = bazaar_qodef_add_admin_row(
			array(
		...
		$row_heading_h6_3 = bazaar_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'bazaar' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = bazaar_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'bazaar' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = bazaar_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'bazaar' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = bazaar_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'bazaar' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = bazaar_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = bazaar_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = bazaar_qodef_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'bazaar' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'bazaar' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'bazaar' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'bazaar' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'bazaar' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = bazaar_qodef_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'bazaar' ),
				'description' => esc_html__( 'Define styles for link text', 'bazaar' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'bazaar' ),
				'parent'        => $row_link_1
			)
		);
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'bazaar' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = bazaar_qodef_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'bazaar' ),
				'options'       => bazaar_qodef_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'bazaar' ),
				'options'       => bazaar_qodef_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'bazaar_qodef_options_map', 'bazaar_qodef_fonts_options_map', 7 );
}