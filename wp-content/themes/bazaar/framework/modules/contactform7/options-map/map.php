...
if ( ! function_exists('bazaar_qodef_contact_form_7_options_map') ) {

	function bazaar_qodef_contact_form_7_options_map() {

		bazaar_qodef_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'bazaar'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = bazaar_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'bazaar')
		));

		//Text Typography

		$typography_text_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'bazaar'),
			'description'	=> esc_html__('Setup typography for form elements text', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'bazaar'),
		));
		...
		$typography_text_row2 = bazaar_qodef_add_admin_row(array(
		...
		$typography_text_row3 = bazaar_qodef_add_admin_row(array(
		...
		$typography_label_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'bazaar'),
			'description'	=> esc_html__('Setup typography for form elements label', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = bazaar_qodef_add_admin_row(array(
		...
		$typography_label_row2 = bazaar_qodef_add_admin_row(array(
		...
		$background_border_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'bazaar'),
			'description'	=> esc_html__('Setup form elements background and border style', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'bazaar')
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'bazaar')
		));

		$background_border_row2 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'bazaar'),
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'bazaar')
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'bazaar')
		));

		$background_border_row3 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'bazaar'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = bazaar_qodef_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'bazaar'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'bazaar'),
			'description'	=> esc_html__('Setup form elements margin', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = bazaar_qodef_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'bazaar'),
			'description'	=> esc_html__('Enter height for textarea form element', 'bazaar'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'bazaar'),
			'description'	=> esc_html__('Setup button text typography', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = bazaar_qodef_add_admin_row(array(
		...
		$button_typography_row2 = bazaar_qodef_add_admin_row(array(
		...
		$button_background_border_group = bazaar_qodef_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'bazaar'),
			'description'	=> esc_html__('Setup button background and border style', 'bazaar'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'bazaar')
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'bazaar')
		));

		$button_background_border_row2 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'bazaar')
		));
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'bazaar')
		));

		$button_background_border_row3 = bazaar_qodef_add_admin_row(array(
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'bazaar'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		bazaar_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'bazaar'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = bazaar_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'bazaar')
		));
        ...
        $panel_contact_form_style_3 = bazaar_qodef_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'bazaar')
        ));
        ...
        $typography_label_row3 = bazaar_qodef_add_admin_row(array(
        ...
        $button_typography_row3 = bazaar_qodef_add_admin_row(array(
	...
	add_action( 'bazaar_qodef_options_map', 'bazaar_qodef_contact_form_7_options_map', 20);
}