...
if ( ! function_exists( 'bazaar_qodef_get_title_types_options' ) ) {
	function bazaar_qodef_get_title_types_options() {
		$title_type_options = apply_filters( 'bazaar_qodef_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'bazaar_qodef_get_title_type_default_options' ) ) {
	function bazaar_qodef_get_title_type_default_options() {
		$title_type_option = apply_filters( 'bazaar_qodef_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('bazaar_qodef_title_options_map') ) {
	function bazaar_qodef_title_options_map() {
		$title_type_options        = bazaar_qodef_get_title_types_options();
		$title_type_default_option = bazaar_qodef_get_title_type_default_options();
		...
		$panel_title = bazaar_qodef_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'bazaar')
			)
		);
		...
		bazaar_qodef_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'bazaar' ),
				'parent'        => $panel_title,
				'args'          => array(
					'dependence'             => true,
			...
			$show_title_area_container = bazaar_qodef_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				bazaar_qodef_add_admin_field(
					...
					bazaar_qodef_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'bazaar' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'bazaar_qodef_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = bazaar_qodef_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = bazaar_qodef_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'bazaar' ),
					'description' => esc_html__( 'Define styles for page title', 'bazaar' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = bazaar_qodef_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = bazaar_qodef_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = bazaar_qodef_add_admin_row(
					array(
			...
			bazaar_qodef_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'bazaar' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = bazaar_qodef_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'bazaar' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'bazaar' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = bazaar_qodef_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = bazaar_qodef_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = bazaar_qodef_add_admin_row(
					array(
		...
		do_action( 'bazaar_qodef_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'bazaar_qodef_options_map', 'bazaar_qodef_title_options_map', 6);
}