...
namespace QodeCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Select Product List - Carousel', 'bazaar' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'bazaar' ),
							'value'       => array(
	...
	public function render( $atts, $content = null ) {
        ...
        $html = '';
			$html.= '<div class="qodef-plc-holder '. esc_attr($params['holder_classes']). ' ">';
