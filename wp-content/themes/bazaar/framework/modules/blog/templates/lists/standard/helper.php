...
if( !function_exists('bazaar_qodef_get_blog_holder_classes') ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function bazaar_qodef_get_blog_holder_classes($classes) {
	...
	add_filter( 'bazaar_qodef_blog_holder_classes', 'bazaar_qodef_get_blog_holder_classes' );
}
