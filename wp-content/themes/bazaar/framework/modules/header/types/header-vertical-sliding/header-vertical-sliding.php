...
class HeaderVerticalSliding extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = bazaar_qodef_vertical_sliding_header_holder_class();
		
		$parameters = apply_filters( 'bazaar_qodef_header_vertical_sliding_parameters', $parameters );
