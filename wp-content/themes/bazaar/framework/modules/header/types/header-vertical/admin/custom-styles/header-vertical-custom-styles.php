...
if ( ! function_exists( 'bazaar_qodef_vertical_main_menu_styles' ) ) {
	...
	function bazaar_qodef_vertical_main_menu_styles() {
		...
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = bazaar_qodef_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = bazaar_qodef_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo bazaar_qodef_dynamic_css( $menu_holder_selector, $menu_holder_styles );
