<?php
namespace BazaarQodef\Modules\Header\Lib;
/**
 * Class BazaarQodefHeaderConnector
 *
...
class BazaarQodefHeaderConnector {
    ...
    public function connect($config = array()) {
        do_action('bazaar_qodef_pre_header_connect');
        ...
        if(!empty($config['affect_content'])) {
            add_filter('bazaar_qodef_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if(!empty($config['affect_title'])) {
            add_filter('bazaar_qodef_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('bazaar_qodef_after_header_connect');
    }
     ...
     *
     * Hooks to bazaar_qodef_title_content_padding filter
     *
     * @return int
     */
