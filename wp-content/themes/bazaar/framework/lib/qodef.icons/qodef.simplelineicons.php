...
class BazaarQodefSimpleLineIcons implements iBazaarQodefIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'bazaar'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'bazaar'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'bazaar'),
            'icon-social-facebook'    => esc_html__('Facebook', 'bazaar'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'bazaar'),
            'icon-social-github'      => esc_html__('Github', 'bazaar'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'bazaar'),
            'icon-social-instagram'   => esc_html__('Instagram', 'bazaar'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'bazaar'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'bazaar'),
            'icon-social-reddit'      => esc_html__('Reddit', 'bazaar'),
            'icon-social-skype'       => esc_html__('Skype', 'bazaar'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'bazaar'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'bazaar'),
            'icon-social-spotify'     => esc_html__('Spotify', 'bazaar'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'bazaar'),
            'icon-social-twitter'     => esc_html__('Twitter', 'bazaar'),
            'icon-social-youtube'     => esc_html__('Youtube', 'bazaar')
        );
    }
