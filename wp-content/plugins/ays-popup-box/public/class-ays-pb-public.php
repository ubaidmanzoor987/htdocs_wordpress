...
class Ays_Pb_Public {
	...
	public function ays_generate_popup( $attr ){
        ...
        if(isset($popupbox['onoffswitch']) && $popupbox['onoffswitch'] == 'On'){
            ...
            if(!isset($_COOKIE['ays_show_popup_only_once_'.$id]) && isset($options['show_only_once']) && $options['show_only_once'] == 'on'){
            ...
            //Animation Speed
            $ays_pb_animation_speed = (isset($options["animation_speed"]) && $options["animation_speed"] != '') ? absint( intval($options["animation_speed"]) ) : 1;
            $ays_pb_animation_close_milleseconds = $ays_pb_animation_speed * 1000;
    ...
    /*******************************************************************************************************/
                                ...
                                $(window).scroll(function() {
                                    if(($(this).scrollTop() >= ays_pb_scrollTop_".$id.") && (count === 0)) {
                                        ...
                                        if (".$close_button_delay." != 0 && '".$closeButton."' != 'on') {
                                            ...
                                            $(document).find('.ays-pb-close-button-delay').css({'display': 'none'});
                                            setTimeout(function(){ 
                                                $(document).find('.ays-pb-close-button-delay').css({'display': 'block'});
                                            }, close_button_delay );
                                        }
            ...
            if($ays_pb_action_buttons_type != 'pageLoaded'){
                $popupbox_view .= "                
                    <script>
                        ...
                        $(document).ready(function(){       
                            var ays_flag = true;
                            $(document).find('".$ays_pb_action_buttons."').on('click', function(){
            ...
            if ($close_button_delay != 0 && $closeButton != 'on' && $ays_pb_scroll_top == 0) {
                ...
                <script>
                    jQuery(document).ready(function() {
                        jQuery(document).find('.ays-pb-close-button-delay').css({'display': 'none'});
                        setTimeout(function(){ 
                            jQuery(document).find('.ays-pb-close-button-delay').css({'display': 'block'});
                        },". $close_button_delay .");
                    })
                </script>";
            }
