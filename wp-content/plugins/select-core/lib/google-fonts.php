<?php
if ( ! function_exists( 'bazaar_qodef_init_google_fonts_array' ) ) {
    function bazaar_qodef_init_google_fonts_array() {
        ...
        $bazaar_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'bazaar_qodef_init_google_fonts_array');
}