...
class ImageWithText implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Text Layout', 'select-core' ),
							'value'      => array(
								esc_html__( 'Text Below Image', 'select-core' ) => '',
								esc_html__( 'Text Over Image', 'select-core' )  => 'text-over-image'
							)
						),
						array(
							'type'       => 'textfield',
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['text_layout'] ) ? 'qodef-iwt-' . $params['text_layout'] : '';
