...
class Banner implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Additional Image', 'select-core' ),
							'description' => esc_html__( 'Image will be set over the initial image.', 'select-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Zoom Image', 'select-core' ) => 'qodef-zoom-image',
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . bazaar_qodef_filter_px( $params['link_top_margin'] ) . 'px';
		}
