...
if ( ! function_exists( 'bazaar_qodef_get_social_share_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function bazaar_qodef_get_social_share_html( $params = array() ) {
		if ( bazaar_qodef_core_plugin_installed() ) {
			return bazaar_qodef_execute_shortcode( 'qodef_social_share', $params );
		}
	}
}

if ( ! function_exists( 'bazaar_qodef_the_excerpt_max_charlength' ) ) {
	/**
	 ...
	 */
	function bazaar_qodef_the_excerpt_max_charlength( $charlength ) {
		$twitter_via_meta = bazaar_qodef_options()->getOptionValue( 'twitter_via' );
